...
> `feature`는 legacy 라벨이다. 신규 이슈에는 쓰지 않는다. 재정 근거와 반대 방향 근거, 사용 이력은 #2458에 있다. 이슈 type과 라벨의 매핑은 [00-issue-management.md](../../docs/runbooks/00-issue-management.md) §2, 라벨 목록과 용도는 같은 문서 §4가 SSOT다.
