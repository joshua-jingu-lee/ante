...
- 타입 라벨 없이 편입된 이슈의 브랜치 prefix와 커밋 type은 [03-git-workflow.md](../../docs/runbooks/03-git-workflow.md) §1.2 「타입 라벨이 없는 이슈의 prefix 결정」이 정본이다. 라벨이 비어 있다는 이유로 임의 prefix를 쓰지 않는다.
