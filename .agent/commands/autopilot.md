...
🤖 **Autopilot 보류**
- 이슈: #{번호}
- 사유: {needs-triage | 타입 라벨 부재 | 선행 이슈 미완료 | plan-preflight blocked | plan-preflight needs-rewrite | plan-preflight revise-plan | needs-spec-first | split-issue | invoke-human}
