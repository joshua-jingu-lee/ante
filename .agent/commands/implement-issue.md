...
위 스니펫의 `high`는 레벨을 지정한 호출 형태를 보이는 **예시**다. 이 게이트가 어떤 레벨로 호출할지에 대한 규범은 [#2469](https://github.com/joshua-jingu-lee/ante/issues/2469)가 확정한다.
